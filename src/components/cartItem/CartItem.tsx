    ...
    <section className="bg-[#d1d5db] py-12">
      <div className="container">
          {cart.length > 0 ? (
            ...
            <div className="right w-full lg:w-[75%] bg-white p-[15px] rounded-[10px]">
                    ...
                    <div className="cart-body">
                      <div className="flex justify-between">
                        <div className="cart-body-head mb-[10px]">
                          ...
                          <p className="cart-desc text-[#777] w-full lg:w-[65%]">
                          ...
                          <div className="cart-price">unit price : 
                            <span className='font-bold'>{` $${product.newPrice.toFixed(2)}`}</span>
                          </div>
                        </div>
            ...
            <div className="left w-full lg:w-[25%] bg-white p-[15px] h-[220px] rounded-[10px]">
              <div className="box">
